...
<div class="bungkus_utama">
    <div class="cetak-tambah">
                <a href="tambah_prestasi.php" class="btn btn-success mr-2">tambah data
...
<table  >
    ...
    <?php foreach($prestasi as $row) : ?>
        ...
        <tr>
            ...
            <td >
                <a class="btn btn-primary " href="ubah_prestasi.php?id=<?= $row["id"];  ?>"> 
                            <i class="fa fa-edit"></i>
                             Ubah</a> 
                <a class="btn btn-danger" href="hapus_prestasi.php?id=<?= $row["id"];  ?>" onclick=" return confirm('apakah anda yakin ingin menghapus data ini?')">
