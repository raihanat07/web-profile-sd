...
<div class="bungkus_utama">
    <div class="cetak-tambah">
                <a href="tambah_ptk.php" class="btn btn-success mr-2">tambah data
...
<table  >
    ...
    <?php foreach($ptk as $row) : ?>
        ...
        <tr>
            ...
            <td >
                <a class="btn btn-primary " href="ubah_ptk.php?id=<?= $row["id"];  ?>"> 
                            <i class="fa fa-edit"></i>
                             Ubah</a> 
                <a class="btn btn-danger" href="hapus_ptk.php?id=<?= $row["id"];  ?>" onclick=" return confirm('apakah anda yakin ingin menghapus data ini?')">
