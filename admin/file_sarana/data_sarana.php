...
<div class="bungkus_utama">
    <div class="cetak-tambah">
                <a href="tambah_sarana.php" class="btn btn-success mr-2">tambah data 
...
<table  >
    ...
    <?php foreach($sarana as $sar) : ?>
        ...
        <tr>
            ...
            <td><?= $sar["status"]  ?></td>
            <td >
                <a class="btn btn-primary " href="ubah_sarana.php?id=<?= $sar["id"];  ?>"> 
                            <i class="fa fa-edit"></i>
                             Ubah</a> 
                <a class="btn btn-danger" href="hapus_sarana.php?id=<?= $sar["id"];  ?>" onclick=" return confirm('apakah anda yakin ingin menghapus data ini?')">
