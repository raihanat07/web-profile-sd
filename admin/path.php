<?php 
// session_start();
      // memeriksa apakah user telah login/belum
    // if( !isset($_SESSION["login"]) ){
    //     header("Location: ../file_login/login.php");
    //     exit;
    // }
?>
<!DOCTYPE html>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-brand-text mx-2">Admin Web</div>
      </a>
...
<div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
                  <h6 class="collapse-header">Fitur Lainya:</h6>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" 
                                                                ...
                                                                <?php if ($halaman == "ganti_password") {?>
                                                                    href="ganti_password.php"
                                                                <?php } else  {?>
                                                                    href="../file_ganti_password/ganti_password.php"
                                                                <?php } ?>
